...
3. Select **Overprint** from the repository list. Find **Overprint**, click **Install**, then **Apply Pending Changes**.
...
```sh
python packages/kicad/tests/validate_package.py dist/overprint-kicad-0.1.12.zip /Applications/KiCad/KiCad.app/Contents/SharedSupport/schemas/pcm.v2.schema.json
```
