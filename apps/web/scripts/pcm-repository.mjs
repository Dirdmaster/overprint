...
export const writePcmRepository = (archive, destination, baseUrl = 'https://overprint.ink/pcm/', timestamp = Math.floor(Date.now() / 1000)) => {
  ...
  metadata.versions[0] = {
    ...metadata.versions[0],
    download_url: new URL(filename, baseUrl).href,
